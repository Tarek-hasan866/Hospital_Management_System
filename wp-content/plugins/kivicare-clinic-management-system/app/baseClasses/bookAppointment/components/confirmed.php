...
$appointment_id = isset($_GET['confirm_page']) && !empty($_GET['confirm_page']) ? sanitize_text_field(wp_unslash($_GET['confirm_page'])) : 'off';
    ...
    <div class="d-flex flex-wrap gap-1 justify-content-center kc-confirmation-buttons">
        ...
        if(kcGetSingleWidgetSetting('widget_print')){
            ...
            <button type="button" id='kivicare_print_detail'
                    class="iq-button iq-button-secondary"><?php echo esc_html__('Print Detail', 'kc-lang'); ?>
            </button>
            <?php
        }?>
