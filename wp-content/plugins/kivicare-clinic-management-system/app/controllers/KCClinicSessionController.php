...
class KCClinicSessionController extends KCBase
{
    ...
    public function save () {
        ...
        switch ($this->getLoginUserRole()) {
            ...
            case $this->getClinicAdminRole():
                ...
                break;
            default:
                $clinic_id =  isset($request_data['clinic_id']['id']) && !empty($request_data['clinic_id']['id']) ? $request_data['clinic_id']['id'] :kcGetDefaultClinicId();
                break;
        }
        ...
        if (isset($request_data['id']) && $request_data['id'] !== '' ) {
            ...
            if(!($this->sessionPermissionUserWise($request_data['id']))){
                echo json_encode( [
                    'status'      => false,
                    'status_code' => 403,
                    'message'     =>  $this->permission_message,
    ...
    public function delete () {
        ...
        if (isset($request_data['session_id']) && $request_data['session_id'] !== '' ) {
            ...
            if(!($this->sessionPermissionUserWise($request_data['session_id']))){
                echo json_encode( [
                    'status'      => false,
                    'status_code' => 403,
                    'message'     =>  $this->permission_message,
