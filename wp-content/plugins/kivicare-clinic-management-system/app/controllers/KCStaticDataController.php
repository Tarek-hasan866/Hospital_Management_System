...
class KCStaticDataController extends KCBase {
	...
	public function save() {
        ...
        if(!empty($existItem)){
            echo json_encode([
                'status' => false,
                'message' => esc_html__('Similar value already exist in database', 'kc-lang')
            ]);
            die;
        }
		...
		if (!isset($request_data['id'])) {
            ...
            $message = esc_html__('Static data saved successfully', 'kc-lang');
		} else {
                ...
                switch ($type) {
                    ...
                    case "get_users_by_clinic":
                        ...
                        if($prefix_postfix != null){
                            ...
                            $data['prefix'] = (isset($prefix_postfix->currency_prefix) && $prefix_postfix->currency_prefix !== 'null') ? $prefix_postfix->currency_prefix : '';
                            $data['postfix'] = (isset($prefix_postfix->currency_postfix) && $prefix_postfix->currency_postfix !== 'null') ? $prefix_postfix->currency_postfix : '';
                        }
